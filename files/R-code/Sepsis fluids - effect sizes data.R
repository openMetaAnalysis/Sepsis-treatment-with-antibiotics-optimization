...
dataframe <- read.table(textConnection('
  ...
  "Leisman",    2016, 27085369, 0.63, 0.46, 0.86,  1866, "Mortality", 1,   "Initiation",   "100%",       "normal"
  "Kuttab",     2011, 31393324, 1.52, 1.03, 2.24,  1032, "Mortality", 1,   "Completion",     "100%",       "normal"
  "Pruinelli",  2018, 29298189,   NA,   NA,   NA,  5072, "Mortality", 1,   "Initiation",   "100%",       "normal"
  "Seymour",    2018*, 28528569, 1.01, 0.99, 1.02, 26978, "Mortality", 1,   "Completion",   "100%",       "normal"
...
#---------------------------------
write.table(dataframe, file = "all-studies.csv", append = FALSE, quote = TRUE, sep = ", ",
...
forest(meta1, sort=meta1$Year,bylab ='Fluid: ', byseparator=NULL , resid.hetlab = "Residual I2: ",
